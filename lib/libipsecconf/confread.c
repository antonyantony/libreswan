...
# define DOPT(kbf, v)  { d->options[kbf] = (v); }
	...
	DOPT(KNCF_IKE_MAXTIME_MS, IKE_SA_LIFETIME_DEFAULT * 1000);
	...
	DOPT(KNCF_IPSEC_MAXTIME_MS, IPSEC_SA_LIFETIME_DEFAULT * 1000);
	DOPT(KNCF_REKEYMARGIN_MS, SA_REPLACEMENT_MARGIN_DEFAULT * 1000);
	DOPT(KNCF_IPSE_MAXBYTES, IPSEC_SA_MAX_DEFAULT);
	DOPT(KNCF_IPSE_PACKETS, IPSEC_SA_MAX_DEFAULT);
