...
const struct keyword_def ipsec_conf_keywords[] = {
  ...
  { "keylife",  kv_conn | kv_alias,  kt_time,  KNCF_IPSEC_MAXTIME_MS, NULL, NULL, },
  { "lifetime",  kv_conn | kv_alias,  kt_time,  KNCF_IPSEC_MAXTIME_MS, NULL, NULL, },
  { "salifetime",  kv_conn,  kt_time,  KNCF_IPSEC_MAXTIME_MS, NULL, NULL, },
  { "ipsec-max-bytes",  kv_conn,  kt_byte,  KNCF_IPSE_MAXBYTES, NULL, NULL, },
  { "ipsec-max-packets",  kv_conn,  kt_binary,  KNCF_IPSE_PACKETS, NULL, NULL, },
  ...
  { "ike-max-time",  kv_conn,  kt_time,  KNCF_IKE_MAXTIME_MS, NULL, NULL, },
